...
function Header() {
  return (
    <>
      <div className="bg-blue-900 text-white h-36 p-5 rounded-3xl">
        <h2 className=" mb-6 text-2xl font-medium">
          Int.M.Sc. IT Software Development (Web & Mobile) (B.Sc. IT + M.Sc.IT){" "}
        </h2>
        <table className="w-full border-spacing-y-3">
          <tr>
            <td>
              <svg
                class="w-8 h-8 text bg-blue-900 "
                aria-hidden="true"
            ...
            <td className="">
              <svg
                class="w-8 h-8 text bg-blue-900 dark:text-blue-400"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
